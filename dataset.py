...
def prediction_dataset(folder, coordinates):
    """
    ...
    for index in range(6, len(files)):
        ...
        if folder == 'quantidade casos':
            ...
            rainfall_folder = 'distribuicao chuva casos'
            wind_speed_folder = "vento casos"
            temp_folder = "temperatura casos"
            humidity_folder = "umidade relativa casos"
